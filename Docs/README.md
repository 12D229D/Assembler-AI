...
- **Soporte Multi-LLM**: Integración nativa con Google Gemini, OpenAI, Anthropic Claude y proveedores compatibles con OpenAI (Groq, Ollama, etc.).
...
- **Interfaz Moderna**: UI responsiva con panel lateral deslizable, soporte para pantallas móviles y gestión de perfiles.
...
El proyecto cuenta con un sistema integral de documentación. Consulta la lista de archivos `.md` en la raíz del repositorio para obtener detalles sobre arquitectura, API, pruebas, despliegue y más.
